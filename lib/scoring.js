...
function scorePosts(tweets) {
  ...
  const keywordFrequencyScore = clamp((avgMentionsPerPost / 0.45) * 100, 0, 100);
  ...
  const consistencyScore = clamp((distinctArcDays / 15) * 100, 0, 100); // 15+ active days = full score
